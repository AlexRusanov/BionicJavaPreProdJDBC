...
public class OrderController {
    ...
    @PostMapping("newOrder/removeFromBasket")
    public String removeFromBasket(@SessionAttribute("currentOrder") Order currentOrder, Integer productId){

        orderService.removeProductFromOrder(currentOrder, productId);
